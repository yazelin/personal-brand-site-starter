---
name: brand-site
description: 做個人品牌網站。當使用者說要做個人網站、一頁式網站、作品集、接案頁、求職頁、線上名片，或是要幫別人做這些的時候使用。會先訪談問出他真正要促成哪一件事，再替他選後端、生站、驗收，最後迴圈優化到受眾覺得有用、使用者覺得是他的為止。六種版面、四種風格、五種會流動的首屏，附四個行業的完整範例。零依賴零 build step。
---
