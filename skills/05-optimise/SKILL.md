...
**三個模型各打一次，每一項取中位數，加起來就是這一輪的分數，滿分 25。**
取中位數不取平均，因為有模型會整排給高分。

### 分數怎麼讀

| 總分 | 意思 |
|---|---|
| 20 以上 | 可以停了。剩下的是使用者那一邊的事 |
...
**分數就是同一件事的可比較版本，讓你看得出有沒有進步。**

## 有兩種受眾的話，兩種都要跑

樞紐型的站（同時放作品、寫作、課程）常常同時服務兩三種人。
**分別跑，分數會差很多，而且失敗的方式往往是相反的。**

實測跑過一個真實的站（作品加寫作加課程的樞紐），同一頁：

| 受眾 | 懂 | 下一步 | 信任 | 完整 | 會聯絡 | 總分 |
|---|---|---|---|---|---|---|
| 想學的人 | 4 | 4 | 4 | 2 | 2 | 16 |
| 企業窗口 | 3 | 2 | 3 | 2 | 2 | 12 |

文字回饋更清楚，**兩邊嫌的是同一批內容，理由完全相反**：

- 想學的人：「這看起來像是一個強者的作品集，而不是教我怎麼做。
  他強調維護三十多個專案，反而讓我覺得這對我這種外行來說太難。」
- 企業窗口：「七成是漫畫、貼圖、遊戲和角色創作，完全看不到產線在用的系統實績，
  這會讓我瞬間覺得他是沒碰過機台的簡報型顧問。」

**同一批作品，對 A 是「太強所以我學不會」，對 B 是「太玩所以不敢交給你」。**

### 遇到這種衝突不要靠加東西解

加東西只會讓兩邊都更長更雜。三個做法選一個，**這一題要使用者拍板**：

1. **選一個主受眾**，另一種放到子頁。首頁只服務一種人。
2. **第一屏就分流**：兩個入口，各自進到自己的區塊。
   代價是首屏要多一次選擇，會流失一些人。
3. **同一批內容換講法**：每件作品加一行「用了什麼、花多久」給想學的人，
   另外獨立一區「產線上真的在跑的」給企業窗口。

**不要問使用者「你想服務誰」，他會說都要。**
把兩份分數與兩段原話念給他聽，再問他「哪一邊你比較捨得放掉」。
