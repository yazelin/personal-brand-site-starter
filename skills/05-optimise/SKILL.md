...
**一、中位數會蓋掉異議。** 三個評審裡兩個給 5，中位數就是 5，
第三個給 2 完全看不到。**所以每一項的最低分也要一起看**，
中位數與最低分差兩分以上的那一項，要自己去看那個評審為什麼給低。

**二、同一頁跑兩次會差一到兩分。** 實測同一份頁面連跑兩次拿到 25 與 23。
**所以差三分以內不算有動**，不要把雜訊當成進步。

**三、接近滿分要懷疑。** 25 分很罕見。真的拿到的時候先看最低分那一列，
再看文字回饋裡有沒有人講出具體的缺點。
